...
class _CheckUpdateScreenState extends State<CheckUpdateScreen> {
  ...
  final List<Map<String, dynamic>> _devices = [
    {'id': '1', 'name': 'LynShae Pro', 'type': '机器狗', 'firmwareVersion': '1.0.0'},
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: const Text('立即更新', style: TextStyle(color: AppTheme.primaryBlue)),
          ),
        ],
      ),
    );
          ...
          children: [
            ...
            if (result['forceUpdate'] == true) ...[
              ...
              Container(
                ...
                child: const Row(
                  children: [
                    Icon(Icons.warning_rounded, color: AppTheme.accentOrange, size: 18),
                    SizedBox(width: 8),
                    Expanded(
                      child: Text(
                        '此更新为强制更新，请尽快完成升级',
