...
class DeviceDetailScreen extends StatefulWidget {
  ...
  const DeviceDetailScreen({super.key, required this.product});
...
class _DeviceDetailScreenState extends State<DeviceDetailScreen> {
  ...
  void initState() {
    super.initState();
    _isOn = widget.product.isOn;
    _isConnected = widget.product.isOnline;
    _batteryLevel = widget.product.batteryLevel;
  }
