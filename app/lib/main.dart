...
class _LynshaeAppState extends State<LynshaeApp> {
  ...
  void initState() {
    ...
    AuthService.loginStateNotifier.addListener(_onLoginStateChanged);
    _checkLoginStatus();
  }
  ...
  void dispose() {
    ...
    AuthService.loginStateNotifier.removeListener(_onLoginStateChanged);
    super.dispose();
  }

  void _onLoginStateChanged() {
    // 延迟检查以确保 SharedPreferences 已更新
