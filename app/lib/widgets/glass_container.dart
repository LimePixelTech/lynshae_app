    ...
    final effectiveShadow = boxShadow ?? [
      BoxShadow(
        color: isDark
            ...
            : AppTheme.warmBrown.withAlpha(12),
      ...
      BoxShadow(
        color: isDark
            ...
            : AppTheme.warmBeige.withAlpha(8),
    ...
    final effectiveGradient = gradient ?? (isDark && useGradientOverlay
        ...
        : (isDark
            ? LinearGradient(
                ...
                colors: [
                  AppTheme.darkCardElevated.withAlpha(100),
                  AppTheme.darkBgTop.withAlpha(150),
                ],
              )
            : LinearGradient(
                begin: Alignment.topLeft,
                ...
                colors: [
                  ...
                  AppTheme.warmCream.withAlpha(120),
                ],
              )));
        ...
        decoration: BoxDecoration(
          ...
          color: isPrimary
              ? (isDark 
                  ...
                  : AppTheme.warmBeige.withAlpha(255))
              : (color ?? (isDark
                  ? AppTheme.darkCardElevated.withAlpha(150)
                  : AppTheme.warmCream.withAlpha(200))),
          border: isPrimary
              ? null
              : Border.all(
                  color: isDark
          ...
          boxShadow: isPrimary
              ? [
                  BoxShadow(
                    color: isDark
                        ? AppTheme.primaryBlue.withAlpha(60)
                        : AppTheme.warmBeige.withAlpha(80),
                    blurRadius: 20,
                    spreadRadius: -4,
                  ),
...
class GlassInput extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GlassContainer(
      ...
      color: isDark
          ? AppTheme.darkCardElevated.withAlpha(100)
          : AppTheme.warmCream.withAlpha(180),
      borderColor: isDark
                ...
                gradient: RadialGradient(
                  colors: [
                    ...
                    isDark 
                        ...
                        : AppTheme.warmBeige.withAlpha(0),
                  ],
                ),
              ),
            ),
                ...
                gradient: RadialGradient(
                  colors: [
                    ...
                    isDark 
                        ...
                        : AppTheme.warmCoral.withAlpha(0),
                  ],
                ),
              ),
            ),
                ...
                gradient: RadialGradient(
                  colors: [
                    isDark 
                        ...
                        : AppTheme.warmGold.withAlpha(15),
                    isDark 
                        ? AppTheme.accentOrange.withAlpha(0) 
                        : AppTheme.warmGold.withAlpha(0),
                  ],
                ),
              ),
            ),
            ...
            Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    Colors.transparent,
                    AppTheme.darkBgTop.withAlpha(50),
                  ],
                ),
              ),
            ),
